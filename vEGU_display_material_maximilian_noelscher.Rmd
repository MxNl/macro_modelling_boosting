...
tar_read(sampledatedistribution_plot)
```
<br />
...
tar_read(sampledepthdistribution_plot)
```
<br />
...
tar_read(measurementdistribution_plot)
```
...
tar_read(samplesparameters_plot)
```
